...
public struct IntervalColor {
    ...
    public static var homeySubtle: [CGColor] {
        [#colorLiteral(red: 0.9529411765, green: 0.8666666667, blue: 0.6705882353, alpha: 1), #colorLiteral(red: 0.4, green: 0.2666666667, blue: 0.2, alpha: 1), #colorLiteral(red: 0.4, green: 0.2666666667, blue: 0.2, alpha: 1), #colorLiteral(red: 0.4, green: 0.2666666667, blue: 0.2, alpha: 1), #colorLiteral(red: 0.4, green: 0.2666666667, blue: 0.2, alpha: 1), #colorLiteral(red: 0.4, green: 0.2666666667, blue: 0.2, alpha: 1), #colorLiteral(red: 0.4, green: 0.2666666667, blue: 0.2, alpha: 1), #colorLiteral(red: 0.4, green: 0.2666666667, blue: 0.2, alpha: 1), #colorLiteral(red: 0.4, green: 0.2666666667, blue: 0.2, alpha: 1), #colorLiteral(red: 0.4, green: 0.2666666667, blue: 0.2, alpha: 1), #colorLiteral(red: 0.4, green: 0.2666666667, blue: 0.2, alpha: 1), #colorLiteral(red: 0.4, green: 0.2666666667, blue: 0.2, alpha: 1)]
    }
